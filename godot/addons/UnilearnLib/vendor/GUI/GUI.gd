...
@onready var colorbutton_scene = preload("res://addons/UnilearnLib/vendor/GUI/ColorPickerButton.tscn")
const GIFExporter = preload("res://addons/UnilearnLib/vendor/addons/gdgifexporter/exporter.gd")
const MedianCutQuantization = preload("res://addons/UnilearnLib/vendor/addons/gdgifexporter/quantization/median_cut.gd")

@onready var planets = {
	"Terran Wet": preload("res://addons/UnilearnLib/vendor/Planets/Rivers/Rivers.tscn"),
	"Terran Dry": preload("res://addons/UnilearnLib/vendor/Planets/DryTerran/DryTerran.tscn"),	
	"Islands": preload("res://addons/UnilearnLib/vendor/Planets/LandMasses/LandMasses.tscn"),
	"No atmosphere": preload("res://addons/UnilearnLib/vendor/Planets/NoAtmosphere/NoAtmosphere.tscn"),
	"Gas giant 1": preload("res://addons/UnilearnLib/vendor/Planets/GasPlanet/GasPlanet.tscn"),
	"Gas giant 2": preload("res://addons/UnilearnLib/vendor/Planets/GasPlanetLayers/GasPlanetLayers.tscn"),
	"Ice World": preload("res://addons/UnilearnLib/vendor/Planets/IceWorld/IceWorld.tscn"),
	"Lava World": preload("res://addons/UnilearnLib/vendor/Planets/LavaWorld/LavaWorld.tscn"),
	"Black Hole": preload("res://addons/UnilearnLib/vendor/Planets/BlackHole/BlackHole.tscn"),
	"Galaxy": preload("res://addons/UnilearnLib/vendor/Planets/Galaxy/Galaxy.tscn"),
	"Star": preload("res://addons/UnilearnLib/vendor/Planets/Star/Star.tscn"),
}
var pixels = 512.0
var sd = 0
var colors = []
